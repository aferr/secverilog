...
# my @files = <*>;
my @files = ("plab4-net-GreedyRouteCompute.v","plab4-net-RingNetBase-NoTP.v","plab4-net-RouterBase-NoTP.v","plab4-net-RouterInputCtrl-Arbiter-NoTP.v","plab4-net-RouterInputCtrl-NoTP.v","plab4-net-RouterInputTerminalCtrl-Arbiter-NoTP.v","plab4-net-RouterInputTerminalCtrl-NoTP.v","plab4-net-RouterOutpuCtrl.v","vc-arbiters.v", "vc-ArbChain.v","vc-crossbars.v","vc-mem-msgs.v","vc-muxes.v","vc-net-msgs.v","vc-queues.v","vc-queues-component.v","vc-regfiles.v","vc-regs.v");
