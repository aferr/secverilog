...
// add instructions for setting read and write labels
`define SETR		16'b0010000000000000
`define SETW		16'b0010010000000000
...
`define	select_bp_reg		2'b00
`define	select_bp_stage3	2'b01		
`define select_bp_stage4	2'b10
...
// comment out the following line for synthesis (for simulation leave it in!)
`define NOSYNTH