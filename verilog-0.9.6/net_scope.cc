...
NetExpr *NetScope::set_parameter(perm_string key, NetExpr *expr,
                                 ivl_variable_type_t type__, NetExpr *msb,
                                 NetExpr *lsb, bool signed_flag,
 ...
 */
const NetExpr *NetScope::get_parameter(const char *key, const NetExpr *&msb,
...
map<perm_string, NetScope::param_expr_t>::iterator
...
NetScope::TYPE NetScope::type() const { return type_; }
...
bool NetScope::in_func() { return (type_ == FUNC) ? true : false; }
...
void NetScope::default_nettype(NetNet::Type nt) { default_nettype_ = nt; }

NetNet::Type NetScope::default_nettype() const { return default_nettype_; }
...
NetScope *NetScope::parent() { return up_; }

const NetScope *NetScope::parent() const { return up_; }
