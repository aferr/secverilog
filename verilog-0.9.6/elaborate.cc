...
void PGAssign::elaborate(Design *des, NetScope *scope) const {
  ...
  if (debug_elaborate) {
    cerr << get_fileline() << ": debug: PGAssign: elaborated l-value"
         << " width=" << lval->vector_width() << ", type=" << lval->data_type()
         << endl;
  }
  ...
  if (type_is_vectorable(rval_expr->expr_type()) &&
    ...
    if (debug_elaborate) {
      cerr << get_fileline() << ": debug: "
           << "r-value expressions width " << rval_expr->expr_width() << " of "
           << (rval_expr->has_sign() ? "signed" : "unsigned")
  ...
  if ((lval->data_type() == IVL_VT_REAL && rval->data_type() != IVL_VT_REAL)) {
  ...
  if (lval->vector_width() > rval->vector_width()) {
    if (rval->get_signed())
      rval = pad_to_width_signed(des, rval, lval->vector_width(), *this);
    else
  ...
  if (lval->vector_width() < rval->vector_width()) {
    ...
    des->add_node(tmp);
    tmp->set_line(*this);
    NetNet *osig = new NetNet(scope, scope->local_symbol(), NetNet::TRI,
                              lval->vector_width());
    osig->set_line(*this);
  ...
  if (need_driver_flag) {
    NetBUFZ *driver =
        new NetBUFZ(scope, scope->local_symbol(), rval->vector_width());
...
NetNode *PGBuiltin::create_gate_for_output_(Design *des, NetScope *scope,
  ...
  case AND:
    if (pin_count() < 2) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::AND,
                          instance_width);
    }
    break;
  ...
  case BUF:
    if (pin_count() < 2) {
      ...
      gate = new NetLogic(scope, gate_name, 2, NetLogic::BUF, instance_width);
    }
    break;
  ...
  case BUFIF0:
    if (pin_count() != 3) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::BUFIF0,
                          instance_width);
    }
    break;
  ...
  case BUFIF1:
    if (pin_count() != 3) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::BUFIF1,
                          instance_width);
    }
    break;
  ...
  case CMOS:
    if (pin_count() != 4) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::CMOS,
                          instance_width);
    }
    break;
  ...
  case NAND:
    if (pin_count() < 2) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::NAND,
                          instance_width);
    }
    break;
  ...
  case NMOS:
    if (pin_count() != 3) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::NMOS,
                          instance_width);
    }
    break;
  ...
  case NOR:
    if (pin_count() < 2) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::NOR,
                          instance_width);
    }
    break;
  ...
  case NOT:
    if (pin_count() < 2) {
      ...
      gate = new NetLogic(scope, gate_name, 2, NetLogic::NOT, instance_width);
    }
    break;
  ...
  case NOTIF0:
    if (pin_count() != 3) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::NOTIF0,
                          instance_width);
    }
    break;
  ...
  case NOTIF1:
    if (pin_count() != 3) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::NOTIF1,
                          instance_width);
    }
    break;
  ...
  case OR:
    if (pin_count() < 2) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::OR,
                          instance_width);
    }
    break;
  ...
  case RCMOS:
    if (pin_count() != 4) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::RCMOS,
                          instance_width);
    }
    break;
  ...
  case RNMOS:
    if (pin_count() != 3) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::RNMOS,
                          instance_width);
    }
    break;
  ...
  case RPMOS:
    if (pin_count() != 3) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::RPMOS,
                          instance_width);
    }
    break;
  ...
  case PMOS:
    if (pin_count() != 3) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::PMOS,
                          instance_width);
    }
    break;
  ...
  case PULLDOWN:
    gate =
        new NetLogic(scope, gate_name, 1, NetLogic::PULLDOWN, instance_width);
    break;

  case PULLUP:
    gate = new NetLogic(scope, gate_name, 1, NetLogic::PULLUP, instance_width);
    break;
  ...
  case XNOR:
    if (pin_count() < 2) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::XNOR,
                          instance_width);
    }
    break;
  ...
  case XOR:
    if (pin_count() < 2) {
      ...
      gate = new NetLogic(scope, gate_name, pin_count(), NetLogic::XOR,
                          instance_width);
    }
    break;
...
void PGBuiltin::elaborate(Design *des, NetScope *scope) const {
  ...
  for (unsigned idx = 0; idx < pin_count(); idx += 1) {
    ...
    if (idx < lval_count) {
      ...
      NetExpr *tmp = elab_and_eval(des, scope, ex, -1, msb_ ? -1 : 1);
      if (tmp == 0)
        continue;
...
NetNet *PGModule::resize_net_to_port_(Design *des, NetScope *scope, NetNet *sig,
  ...
  NetNet *tmp =
      new NetNet(scope, scope->local_symbol(), NetNet::WIRE, port_wid);
  tmp->local_flag(true);
  tmp->set_line(*this);
...
void PGModule::elaborate_mod_(Design *des, Module *rmod,
  ...
  if (debug_elaborate)
    cerr << get_fileline() << ": debug: ...done." << endl;
  ...
  for (unsigned idx = 0; idx < pins.count(); idx += 1) {
      ...
      if (tmp->port_type() == NetNet::PINPUT) {
        ...
        if (warn_portbinding) {
          cerr << get_fileline() << ": warning: "
               ...
               << " with dangling input port '" << rmod->ports[idx]->name;
          switch (rmod->uc_drive) {
          case Module::UCD_PULL0:
    ...
    if (debug_elaborate) {
      cerr << get_fileline() << ": debug: " << get_name() << ": Port "
           << (idx + 1) << " has " << prts.size() << " sub-ports." << endl;
    }
    ...
    for (unsigned inst = 0; inst < instance.size(); inst += 1) {
      ...
      for (unsigned ldx = 0; ldx < mport.size(); ldx += 1) {
        ...
        prts[lbase + ldx] = pport->elaborate_port(des, inst_scope);
        if (prts[lbase + ldx] == 0)
          continue;
    ...
    NetNet *sig;
    if ((prts.size() == 0) || (prts[0]->port_type() == NetNet::PINPUT)) {
      ...
      ivl_variable_type_t tmp_type = IVL_VT_NO_TYPE;
      bool flag                    = false;
      pins[idx]->test_width(des, scope, 0, desired_vector_width, tmp_type,
                            flag);
      NetExpr *tmp_expr = elab_and_eval(
          des, scope, pins[idx], desired_vector_width, desired_vector_width);
      if (tmp_expr == 0) {
      ...
      if (need_bufz_for_input_port(prts)) {
        NetBUFZ *tmp =
            new NetBUFZ(scope, scope->local_symbol(), sig->vector_width());
        des->add_node(tmp);
        connect(tmp->pin(1), sig->pin(0));

        NetNet *tmp2 = new NetNet(scope, scope->local_symbol(), NetNet::WIRE,
                                  sig->vector_width());
        tmp2->local_flag(true);
        tmp2->set_line(*this);
        tmp2->data_type(sig->data_type());
      ...
      if ((sig->data_type() == IVL_VT_REAL) && prts.size() &&
          (prts[0]->data_type() != IVL_VT_REAL)) {
        sig = cast_to_int(des, scope, sig, prts_vector_width / instance.size());
      }
      ...
      if (sig == 0) {
        ...
        cerr << pins[idx]->get_fileline() << ":      : "
             << "Port " << rmod->ports[idx]->name << " of " << rmod->mod_name()
      ...
      if ((sig->data_type() == IVL_VT_REAL) && !prts.empty() &&
        ...
        cerr << pins[idx]->get_fileline() << ": error: "
             << "Cannot automatically connect bit based "
                "inout port "
             << rmod->ports[idx]->name << " of module " << rmod->mod_name()
             << " to real "
                "signal "
             << sig->name() << "." << endl;
        des->errors += 1;
      ...
      if ((sig->data_type() == IVL_VT_REAL) && !prts.empty() &&
        ...
        cerr << pins[idx]->get_fileline() << ": error: "
             ...
             << " cannot have a real port (" << rmod->ports[idx]->name
             << ") connected to a "
                "real signal ("
             << sig->name() << ")." << endl;
        des->errors += 1;
...
#ifndef NDEBUG
    if ((prts.size() >= 1) && (prts[0]->port_type() != NetNet::PINPUT)) {
    ...
    if (debug_elaborate) {
      cerr << get_fileline() << ": debug: " << get_name() << ": Port "
           << (idx + 1) << " has vector width of " << prts_vector_width << "."
           << endl;
    }
    ...
    if ((instance.size() == 1) && (prts_vector_width != sig->vector_width())) {
      ...
      cerr << get_fileline() << ": warning: Port " << (idx + 1) << " (" << tmp3
           << ") of " << type_ << " expects " << prts_vector_width
    ...
    if (prts.size() == 1) {
      ...
      case NetNet::PINPUT:
        ...
        for (unsigned ldx = 0; ldx < prts.size(); ldx += 1) {
          ...
          NetPartSelect *ptmp = new NetPartSelect(sig, spin, sp->vector_width(),
                                                  NetPartSelect::VP);
          des->add_node(ptmp);
  ...
  if (overrides_) {
    if (overrides_->count() > 2) {
      ...
      if (!dynamic_cast<NetEConst *>(rise_expr)) {
        cerr << get_fileline()
             << ": error: UDP rising delay "
                "expression must be constant."
             << endl;
        cerr << get_fileline() << ":      : Cannot calculate " << *rise_expr
             << endl;
        des->errors += 1;
      }
      ...
      if (!dynamic_cast<NetEConst *>(fall_expr)) {
        cerr << get_fileline()
             << ": error: UDP falling delay "
                "expression must be constant."
             << endl;
        cerr << get_fileline() << ":      : Cannot calculate " << *fall_expr
             << endl;
        des->errors += 1;
      }
    }
...
NetExpr *PAssign_::elaborate_rval_(Design *des, NetScope *scope,
  ...
  if (dynamic_cast<NetEConst *>(rv))
    return rv;
  if (dynamic_cast<NetECReal *>(rv))
    return rv;
...
static NetExpr *elaborate_delay_expr(PExpr *expr, Design *des,
  ...
  if (scope->time_from_timescale())
    dly_used_timescale = true;
  else
    dly_used_no_timescale = true;

  if (display_ts_dly_warning && dly_used_no_timescale && dly_used_timescale) {
...
NetProc *PAssign::elaborate(Design *des, NetScope *scope) const {
  ...
  NetExpr *rv =
      elaborate_rval_(des, scope, count_lval_width(lv), lv->expr_type());
  if (rv == 0)
    return 0;
  assert(rv);
    ...
    if (wid > rv->expr_width()) {
      cerr << get_fileline()
           << ": error: Unable to match "
              "expression width of "
           << rv->expr_width() << " to l-value width of " << wid << "." << endl;
      // XXXX delete rv;
      return 0;
    }

    NetNet *tmp = new NetNet(scope, scope->local_symbol(), NetNet::REG, wid);
    tmp->local_flag(true);
    tmp->set_line(*this);
...
NetProc *PBlock::elaborate(Design *des, NetScope *scope) const {
  ...
  NetBlock::Type type =
      (bl_type_ == PBlock::BL_PAR) ? NetBlock::PARA : NetBlock::SEQU;
    ...
    if (ex != 0) {
      ...
      if (debug_elaborate)
        cerr << ex->get_fileline() << ": debug: "
             ...
             << ", type=" << use_type << ", unsized_flag=" << flag << endl;
...
NetProc *PCallTask::elaborate_usr(Design *des, NetScope *scope) const {
  ...
  if (nparms() != def->port_count()) {
    cerr << get_fileline() << ": error: Port count mismatch in call to ``"
         << path_ << "''. Got " << nparms() << " ports, expecting "
         << def->port_count() << " ports." << endl;
    des->errors += 1;
    return 0;
  }
  ...
  if (expr_.count() == 0) {
    ...
    for (unsigned idx = 0; idx < expr_.count(); idx += 1) {
      ...
      if (PEIdent *id = dynamic_cast<PEIdent *>(expr_[idx]->expr())) {
        ...
        NetScope *found_in =
            symbol_search(this, des, scope, id->path(), sig, par, eve);
...
NetProc *PEventStatement::elaborate_wait(Design *des, NetScope *scope,
  ...
  NetEvProbe *wait_pr = new NetEvProbe(scope, scope->local_symbol(), wait_event,
                                       NetEvProbe::ANYEDGE, wait_set->count());
...
NetProc *PForStatement::elaborate(Design *des, NetScope *scope) const {
  ...
  use_width = expr1_->test_width(des, scope, use_width, use_width, expr1_type,
                                 unsized_flag);
  ...
  if (sig == 0) {
    cerr << get_fileline() << ": error: Unable to find variable " << id2->path()
         << " in for-loop increment expression." << endl;
    des->errors += 1;
    return body;
  }
...
NetProc *PTrigger::elaborate(Design *des, NetScope *scope) const {
  ...
  NetScope *found_in = symbol_search(this, des, scope, event_, sig, par, eve);
...
bool Module::elaborate(Design *des, NetScope *scope) const {
  ...
  for (specparam_it_t cur = specparams.begin(); cur != specparams.end();
       cur++) {
    ...
    if (NetECReal *val_cr = dynamic_cast<NetECReal *>(val)) {
      ...
      if (debug_elaborate) {
        cerr << get_fileline() << ": debug: Elaborate "
             << "specparam " << (*cur).first << " value=" << value.real_val
             << endl;
      }
      ...
      if (debug_elaborate) {
        cerr << get_fileline() << ": debug: Elaborate "
             << "specparam " << (*cur).first << " value=" << value.integer
             << endl;
      }
  ...
  if (scheme_type == PGenerate::GS_CASE) {
    if (debug_elaborate)
      cerr << get_fileline() << ": debug: generate case"
           << " elaborating in scope " << scope_path(container) << "." << endl;
...
public:
  top_defparams(Design *des__) : elaborator_work_item_t(des__) {}
...
public:
  later_defparams(Design *des__) : elaborator_work_item_t(des__) {}
