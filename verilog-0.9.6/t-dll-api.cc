...
extern "C" const char *ivl_event_basename(ivl_event_t net) { return net->name; }

extern "C" ivl_scope_t ivl_event_scope(ivl_event_t net) { return net->scope; }
...
extern "C" unsigned ivl_logic_pins(ivl_net_logic_t net) { return net->npins_; }
...
extern "C" int ivl_udp_sequ(ivl_udp_t net) { return net->sequ; }

extern "C" unsigned ivl_udp_nin(ivl_udp_t net) { return net->nin; }

extern "C" unsigned ivl_udp_init(ivl_udp_t net) { return net->init; }
...
extern "C" unsigned ivl_udp_rows(ivl_udp_t net) { return net->nrows; }
...
extern "C" const char *ivl_lpm_basename(ivl_lpm_t net) { return net->name; }
...
extern "C" const char *ivl_lpm_file(ivl_lpm_t net) { return net->file.str(); }

extern "C" unsigned ivl_lpm_lineno(ivl_lpm_t net) { return net->lineno; }
...
extern "C" ivl_lpm_type_t ivl_lpm_type(ivl_lpm_t net) { return net->type; }
...
extern "C" const char *ivl_nature_name(ivl_nature_t net) { return net->name(); }
...
extern ivl_nexus_t ivl_path_source(ivl_delaypath_t net) { return net->src; }
...
extern "C" unsigned ivl_signal_attr_cnt(ivl_signal_t net) { return net->nattr; }
...
extern "C" int ivl_signal_lsb(ivl_signal_t net) { return net->lsb_index; }

extern "C" unsigned ivl_signal_width(ivl_signal_t net) { return net->width_; }

extern "C" ivl_signal_port_t ivl_signal_port(ivl_signal_t net) {
  return net->port_;
}

extern "C" int ivl_signal_local(ivl_signal_t net) { return net->local_; }

extern "C" int ivl_signal_signed(ivl_signal_t net) { return net->signed_; }
...
extern "C" int ivl_signal_integer(ivl_signal_t net) { return net->isint_; }

extern "C" ivl_variable_type_t ivl_signal_data_type(ivl_signal_t net) {
  return net->data_type;
}

extern "C" unsigned ivl_signal_npath(ivl_signal_t net) { return net->npath; }
...
extern "C" unsigned ivl_stmt_lineno(ivl_statement_t net) { return net->lineno; }
...
extern "C" ivl_scope_t ivl_switch_scope(ivl_switch_t net) { return net->scope; }

extern "C" ivl_switch_type_t ivl_switch_type(ivl_switch_t net) {
  return net->type;
}

extern "C" ivl_nexus_t ivl_switch_a(ivl_switch_t net) { return net->pins[0]; }

extern "C" ivl_nexus_t ivl_switch_b(ivl_switch_t net) { return net->pins[1]; }

extern "C" ivl_nexus_t ivl_switch_enable(ivl_switch_t net) {
  return net->pins[2];
}

extern "C" unsigned ivl_switch_width(ivl_switch_t net) { return net->width; }

extern "C" unsigned ivl_switch_part(ivl_switch_t net) { return net->part; }

extern "C" unsigned ivl_switch_offset(ivl_switch_t net) { return net->offset; }

extern "C" const char *ivl_switch_file(ivl_switch_t net) { return net->file; }

extern "C" ivl_island_t ivl_switch_island(ivl_switch_t net) {
  return net->island;
}

extern "C" unsigned ivl_switch_lineno(ivl_switch_t net) { return net->lineno; }
