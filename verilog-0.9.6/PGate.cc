...
perm_string PGModule::get_pin_name(unsigned idx)
{
	return pins_[idx].name;
}

unsigned PGModule::get_pin_count()
{
	return npins_;
}

PExpr* PGModule::get_param(unsigned idx)
{
	return pins_[idx].parm;
}
