...
vvp_fun_pmos_::vvp_fun_pmos_(bool enable_invert) { inv_en_ = enable_invert; }
...
vvp_fun_pmos::vvp_fun_pmos(bool enable_invert) : vvp_fun_pmos_(enable_invert) {}
...
vvp_fun_cmos::vvp_fun_cmos() : vvp_fun_cmos_() {}
...
vvp_fun_rcmos::vvp_fun_rcmos() : vvp_fun_cmos_() {}
