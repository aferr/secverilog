...
void schedule_evctl(struct __vpiHandle *handle, double value, vvp_net_t *event,
                    unsigned long ecount) {
...
void evctl_array::run_run() { array_set_word(mem_, idx_, off_, value_); }
...
vvp_named_event::vvp_named_event(struct __vpiHandle *h) { handle_ = h; }
