...
static void string_value(vpiHandle ref, p_vpi_value vp) {
  ...
  case vpiOctStrVal:
    fprintf(stderr, "ERROR (vpi_const.cc): %%o display of constant strings not "
                    "yet implemented\n");
    assert(0);
    break;
...
static const struct __vpirt vpip_string_rt = {
    vpiConstant, string_get, 0, string_value, 0, 0, 0};
...
static const struct __vpirt vpip_string_temp_rt = {vpiConstant,
                                                   string_get,
                                                   0,
                                                   string_value,
                                                   0,
...
vpiHandle vpip_make_string_const(char *text, bool persistent_flag) {
  ...
  obj = (struct __vpiStringConst *)malloc(sizeof(struct __vpiStringConst));
  obj->base.vpi_type = persistent_flag ? &vpip_string_rt : &vpip_string_temp_rt;
  obj->value         = text;
  obj->value_len     = 0;
...
static const struct __vpirt vpip_string_param_rt = {vpiParameter,
                                                    string_param_get,
...
vpiHandle vpip_make_string_param(char *name, char *text, long file_idx,
                                 long lineno) {
  struct __vpiStringParam *obj;

  obj = (struct __vpiStringParam *)malloc(sizeof(struct __vpiStringParam));
...
static void binary_value(vpiHandle ref, p_vpi_value vp) {
  ...
  case vpiStringVal:
  case vpiRealVal:
    vpip_vec4_get_value(rfp->bits, rfp->bits.size(), rfp->signed_flag, vp);
    break;
...
static const struct __vpirt vpip_binary_rt = {
    vpiConstant, binary_get, 0, binary_value, 0, 0, 0};
...
static const struct __vpirt vpip_binary_param_rt = {vpiParameter,
                                                    binary_param_get,
...
vpiHandle vpip_make_binary_param(char *name, const vvp_vector4_t &bits,
                                 bool signed_flag, long file_idx, long lineno) {
...
static const struct __vpirt vpip_dec_rt = {vpiConstant, dec_get, 0, dec_value,
                                           0,           0,       0};
...
vpiHandle vpip_make_dec_const(int value) {
  ...
  obj = (struct __vpiDecConst *)malloc(sizeof(struct __vpiDecConst));
...
static const struct __vpirt vpip_real_rt = {
    vpiConstant, real_get, 0, real_value, 0, 0, 0};
...
static const struct __vpirt vpip_real_param_rt = {vpiParameter,
                                                  real_param_get,
                                                  real_param_get_str,
                                                  real_value,
                                                  0,
...
vpiHandle vpip_make_real_param(char *name, double value, long file_idx,
                               long lineno) {
  struct __vpiRealParam *obj;

  obj = (struct __vpiRealParam *)malloc(sizeof(struct __vpiRealParam));
