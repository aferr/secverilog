...
extern void compile_dff(char *label, struct symb_s arg_d, struct symb_s arg_c,
                        struct symb_s arg_e, struct symb_s arg_a);

struct __vpiModPath;
extern __vpiModPath *compile_modpath(char *label, struct symb_s drv,
                                     struct symb_s dest);
extern void compile_modpath_src(__vpiModPath *dst, char edge,
                                struct symb_s input, struct numbv_s d,
                                int condit_input, /* match with '0' */
                                struct symb_s path_term_input, bool ifnone);
extern void compile_modpath_src(__vpiModPath *dst, char edge,
                                struct symb_s input, struct numbv_s d,
...
extern void compile_udp_functor(char *label, char *type, vvp_delay_t *delay,
                                unsigned argc, struct symb_s *argv);
 ...
 */
extern void compile_ufunc(char *label, char *code, unsigned wid, unsigned argc,
                          struct symb_s *argv, unsigned portc,
                          struct symb_s *portv, struct symb_s retv,
...
extern void compile_vpi_call(char *label, char *name, long file_idx,
                             long lineno, unsigned argc, vpiHandle *argv);
...
extern void compile_vpi_func_call(char *label, char *name, unsigned vbit,
                                  int vwid, long file_idx, long lineno,
...
extern void compile_variable(char *label, char *name, int msb, int lsb,
                             char signed_flag, bool local_flag);
extern void compile_var_real(char *label, char *name, int msb, int lsb);
...
extern void compile_netw(char *label, char *array_symbol,
                         ...
                         bool signed_flag, bool net8_flag, unsigned argc,
                         struct symb_s *argv);
extern void compile_netw_real(char *label, char *array_symbol,
                              unsigned long array_addr, int msb, int lsb,
                              unsigned argc, struct symb_s *argv);

extern void compile_alias(char *label, char *name, int msb, int lsb,
                          bool signed_flag, unsigned argc, struct symb_s *argv);
extern void compile_alias_real(char *label, char *name, int msb, int lsb,
                               unsigned argc, struct symb_s *argv);
