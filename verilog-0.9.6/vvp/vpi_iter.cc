...
static const struct __vpirt vpip_iterator_rt = {vpiIterator,
                                                0, // vpi_get_
                                                0, // vpi_get_str_
                                                0, // vpi_get_value_
                                                0, // vpi_put_value_
...
vpiHandle vpip_make_iterator(unsigned nargs, vpiHandle *args,
                             bool free_args_flag) {
  struct __vpiIterator *res =
      (struct __vpiIterator *)calloc(1, sizeof(struct __vpiIterator));
