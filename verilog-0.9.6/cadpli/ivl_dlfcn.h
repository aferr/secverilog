...
static __inline__ void ivl_dlclose(ivl_dll_t dll) { dlclose(dll); }
...
static __inline__ void ivl_dlclose(ivl_dll_t dll) { shl_unload(dll); }

static __inline__ const char *dlerror(void) { return strerror(errno); }
#endif
