...
hname_t::hname_t() { number_ = INT_MIN; }
...
perm_string hname_t::peek_name(void) const { return name_; }

bool hname_t::has_number() const { return number_ != INT_MIN; }

int hname_t::peek_number() const { return number_; }
...
bool operator!=(const hname_t &l, const hname_t &r) { return !(l == r); }
